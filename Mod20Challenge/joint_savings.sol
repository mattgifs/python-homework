    ...
    */
    function withdraw(uint amount, address payable recipient) public {
        ...
        */
        ...
        // Call the `transfer` function of the `recipient` and pass it the `amount` to 
        //transfer as an argument.
        // YOUR CODE HERE!
    ...
    function deposit() public payable {
        ...
        /*
        Call the `contractBalance` variable and set it equal to the balance of the 
        contract by using `address(this).balance`.
        */
        // YOUR CODE HERE!
        contractBalance = address(this).balance;
    }
